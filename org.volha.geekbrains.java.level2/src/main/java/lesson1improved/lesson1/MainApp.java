...
//        cat.run(10);
    ...
    private static void compete(Entity[] movingEntities, Obstacle[] obstacles) {
    ...
    private static void train(Entity[] movingEntities, Obstacle[] obstacles) {
        boolean trainRezult;
        for ( Entity movingEntity : movingEntities ) {
            for ( Obstacle obstacle : obstacles ) {
